  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative hidden xl:block w-(--sidebar-width) bg-transparent transition-[width] duration-200 ease-linear flex-shrink-0',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Container query - allows responsive styles based on container width, not viewport
        '@container',
        // Prevent horizontal overflow and ensure content doesn't scroll under fixed sidebar
        'overflow-x-hidden',
        // Inset variant specific styles - uses sidebar gap for spacing, so margin is only for rounded corners
...
function SidebarMenuSkeleton({ className, ...props }: React.ComponentProps<'div'> & {}) {
  return (
    <div
      ...
      {...props}
    >
      <LoadingSpinner size="sm" inline className="text-muted-foreground" />
    </div>
  );
}
